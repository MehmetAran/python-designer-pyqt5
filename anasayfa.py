...
"color: rgb(255, 255, 255);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../arayuz/img/logo_ddvt.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, DDVT):
        ...
        self.label_2.setText(_translate("DDVT", "<html><head/><body><p><span style=\" font-size:36pt; font-weight:600;\">Buraya yazı eklenecek</span></p></body></html>"))
